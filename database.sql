...
--Add a new record.
INSERT INTO "accounts" (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('sam', 'minneapolis', '14', '14', '100000000');
...
DELETE FROM "accounts" WHERE "city" = 'miami' OR "city" = 'pheonix' AND "transactions_completed" < 5;
